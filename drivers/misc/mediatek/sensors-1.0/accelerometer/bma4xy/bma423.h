...
/*!
 *	@brief This API is used to dump regs from the sensor.
 *
 *	@param[out] res_buf : format all the reg result in this buffer
 *	@param[in] dev : Structure instance of bma4_dev.
 *
 *	@return Result of API execution status
 *	@retval Any value -> length of the result string
 */
uint16_t bma423_dump_reg(unsigned char *res_buf, struct bma4_dev *dev);
